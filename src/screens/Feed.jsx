...
export default function Feed({ initialData }) {
  ...
  const { listings, loading, error } = useListings(params, { enabled: isAuthenticated, initialData });
    ...
    <div className="w-full">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
        ...
        <div className="flex gap-2">
          <Link href="/explore" className="btn btn-secondary btn-sm">Explore all</Link>
      ...
      {loading ? (
        ...
        <div className="card p-10 text-center">
          ...
          <Link href="/create-listing" className="btn btn-primary">Create a listing</Link>
        </div>
      ) : (
