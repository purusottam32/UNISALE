  ...
  return (
    <div className="max-w-5xl mx-auto">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div>
          <div className="aspect-square rounded-xl overflow-hidden bg-surface-2 mb-3">
            <img
            ...
            <div className="flex gap-2 overflow-x-auto">
              {images.map((img, i) => (
                <button
                  ...
                  className={`w-16 h-16 rounded-lg overflow-hidden flex-shrink-0 border-2 ${activeImage === i ? "border-primary" : "border-transparent"}`}
                >
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex items-center gap-4 text-sm text-text-muted">
            ...
            {listing.college && <span>📍 {listing.college}</span>}
          </div>
